...
export default async function MatQueuePage({
  ...
  const [{ session, user }, params] = await Promise.all([requireReferee(), searchParams]);
    ...
    return (
      <>
        ...
        <Empty
          ...
          action={
            user.isJury ? (
              <Link href="/mat/poomsae" className="btn-primary btn-sm">
                ...
                >
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                      {isLive ? (
                        <Link href={`/mat/bout/${bout.id}`} className="btn-primary">
                          Score this bout
                        </Link>
                      ) : (
