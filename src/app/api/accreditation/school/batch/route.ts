...
import { cardDataForSchool, renderBatchSheet } from '@/lib/pdf/accreditation-service';
...
export async function GET(request: Request) {
  ...
  return pdfResponse(await renderBatchSheet(school.event, cards), `accreditation-batch-${school.code}.pdf`);
}
