      ...
      <div className="space-y-6">
        ...
        {approved && withPhoto < participants.length && (
          <Notice kind="info">
            ...
            an empty photo box —{' '}
            <Link href={schoolPath(event.slug, 'participants')} className="font-medium underline">
              add photos
            </Link>{' '}
                  ...
                  {participants.map((p) => (
                    <tr key={p.id}>
                      ...
                      <td className="whitespace-nowrap text-xs">
                        {[...new Set(p.entries.map((e) => (e.category.discipline === 'KYORUGI' ? 'Kyorugi' : 'Poomsae')))].join(
                          ' + ',
                        ) || '—'}
                      </td>
                      <td>
